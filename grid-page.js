angular.module('gridPage', [])
    ...
    .directive('gridPageComponent', function() {
        return {
            replace: true,
            template: '<div  ng-class="{\'grid-component\': true, \'mutable\': component.mutable}" ng-style="{\'position\': \'absolute\', \'width\': component.width + \'px\', \'height\': component.height + \'px\', \'top\': component.y + \'px\', \'left\': component.x + \'px\'}">' +
                '<div class="grid-component-drag-handle"></div>' +
                '<div class="grid-component-resize-handle"></div>' +
                '</div>',
